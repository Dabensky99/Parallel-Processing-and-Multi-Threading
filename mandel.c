...
// Create a struct to hold all the parameters from compute_image
typedef struct
{
	struct bitmap *bm;
	double xmin;
...
void show_help()
{
	...
	printf("-n <thread> Set the number of threads. (default=1)\n");
...
int main(int argc, char *argv[])
{
	...
	for (int i = 0; i < numThreads; ++i)
	{
		...
		// allocate a thread_args structure and pass it as the fourth argument to pthread_create
...
void *compute_image(void *x)
{
	...
	thread_args *args = (thread_args *)x;
